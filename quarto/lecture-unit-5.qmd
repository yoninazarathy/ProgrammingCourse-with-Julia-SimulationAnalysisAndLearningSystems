---
title: "Unit 5: More language features for software architecture"
format:
  html:
    toc: true
    code-fold: false
...
Sometimes it's useful to **use values which aren't types as type parameters ("Value types")**. One
...
efficient code or data storage (see example ```RegularPolygon``` below).
