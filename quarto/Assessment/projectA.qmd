---
title: "Project A - Semester 2, 2026"
format:
  html:
    toc: true
    code-fold: false
...
* Ideally use the same accounts you used for BigHW. Choose one of the team members to "own" the repo and the other(s) will be invited as collaborators.  
